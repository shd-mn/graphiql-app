  ...
  return (
    <footer className="padding-x z-50 flex h-10 items-center justify-between bg-blue-600 text-sm text-white">
      <ul className="flex gap-3">
        <li>
          <Link href="https://github.com/shd-mn" target="_blank" className="custom-button">
            Shadman <span className="hidden sm:inline">Alizada</span>
          </Link>
        </li>
        <li>
          <Link href="https://github.com/olitera" target="_blank" className="custom-button">
      ...
      <p>2024</p>
      <div>
        <Link href="https://rs.school/" target="_blank" className="custom-button flex items-center gap-2">
